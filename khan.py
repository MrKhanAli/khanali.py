...
from concurrent.futures import ThreadPoolExecutor as khanali
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
    ...
    def pasw(self):       
            ...
            with khanalissb(max_workers=30) as ssbworld:
...
def cutter():
    ...
    os.system('sort -r '+ssb+' | uniq > '+khanali)
